    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Packges", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Packges_Speeds_SpeedId",
                        column: x => x.SpeedId,
                        principalTable: "Speeds",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Packges_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Packges_Volumes_VolumeId",
                        column: x => x.VolumeId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Payments_Packges_PackageId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Packges_SpeedId",
                table: "Packges",
                column: "SpeedId");

            migrationBuilder.CreateIndex(
                name: "IX_Packges_UserId",
                table: "Packges",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_Packges_VolumeId",
                table: "Packges",
                column: "VolumeId");
